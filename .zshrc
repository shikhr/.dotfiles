...
__conda_setup="$('/home/shikhar/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/shikhar/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/shikhar/miniconda3/etc/profile.d/conda.sh"
    else
